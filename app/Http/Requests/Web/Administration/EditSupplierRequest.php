...
class EditSupplierRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phone_number' => 'required|string|size:12|unique:suppliers,phone_number,'.$this->supplier_id,
            'alternative_phone' => 'nullable|string|size:12',
            'email_address' => 'required|email|unique:suppliers,email_address,'.$this->supplier_id,
