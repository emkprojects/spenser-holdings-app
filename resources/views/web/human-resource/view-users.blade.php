@extends('layouts.admin', ['title' => 'Employees'])
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-10">
                                <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All Employees</h4>
                            </div>

                            @can('add-users')
                            <div class="col-xl-2 float:right;">
                                <a href="/new-employee" class="btn btn-primary record-view-btn" title="Add Record">
                                    <i class="menu-icon icon-base ti tabler-file-plus"></i> New Employee
                                </a>
                            </div>
                            @endcan
                    </div>
  ...
  <script>
    $(document).ready(function() {
        ...
        var table =  $('#record-table').DataTable({
            ...
            { data: 'gender', name: 'user_details.gender'},
            // { data: 'position', name: 'positions.position'},  
            //{ data: 'date_of_birth', name: 'user_details.date_of_birth'},
            { data: 'name', name: 'roles.name'}, 
            { data: 'user_status', name: 'user_statuses.user_status'}, 
