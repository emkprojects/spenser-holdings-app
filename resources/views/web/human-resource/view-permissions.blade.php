    ...
    <div class="row">
        <div class="card">
            ...
            <div class="row">
                    ...
                    <div class="col-xl-10">
                        <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All System Permissions</h4>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="accordion mt-4" id="accordionWithIcon">
                            ...
                            <div class="accordion-item active">
                                ...
                                <div class="accordion-body" id="permission_view"></div>
                                </div>
                            </div>
                ...
                <form method="POST" id="edit-form" nam="edit-form" class="row g-6">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" id="permission_reference_edit" name="permission_reference" class="form-control" />
                            <input type="hidden" id="permission_id_edit" name="permission_id" class="form-control" />

                            <div class="col-md-12 form-control-validation">
                                <label class="form-label fs-6" for="permission">Permission</label>
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text" id="basic-addon-permission">
                                        <i class="icon-base ti tabler-file-text"></i>
                                    </span> 
                                    <input type="text" id="permission_edit" name="permission" class="form-control fs-6" placeholder="Enter permission" style="text-transform:;" />
                                </div> 
                            </div> 
                            ...
                            <div class="col-md-12 form-control-validation">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea id="description_edit" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Permission..." rows="3" style="text-transform:;" ></textarea>
                                </div>
                            </div>            
                ...
                <form method="POST" id="add-form" nam="add-form" class="row g-6">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-control-validation">
                                <label class="form-label fs-6" for="category-type">Permission</label>
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text" id="basic-addon-category-type">
                                        <i class="icon-base ti tabler-file-text"></i>
                                    </span> 
                                    <input type="text" id="permission" name="permission" class="form-control fs-6" placeholder="Enter Permission" style="text-transform:capitalize;" />
                                </div> 
                            </div> 
                            ...
                            <div class="col-md-12 form-control-validation">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea id="description" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Permission..." rows="3" style="text-transform:capitalize;" ></textarea>
                                </div>
                            </div> 
  ...
  <script>
    $(document).ready(function() {
        ...
        var table =  $('#record-table').DataTable({
            ...
            { data: 'is_active', name: 'permissions.is_active'},                           
        ...
        $(document).on('click', '.record-view-btn', function(){
            ...
            $.ajax({
                url: '/specific-permission/'+ record_id,
                type: 'GET',
                ...
                success: function(response) {
                  ...
                  $('#record_header_view').text( (response.data.name) );

                  $('#permission_view').text(response.data.name);
            ...
            var record_id = $(this).attr('id');
              ...
              $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#record_header_edit').text(response.data.name);

                    $('#permission_reference_edit').val(response.data.permission_reference);
                    $('#permission_id_edit').val(response.data.id);
                    $('#permission_edit').val(response.data.name);
        ...
        $(document).on('click', '.record-del-btn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    // },
                    type:'post',
                    url: '/delete-permission/'+ record_id,
