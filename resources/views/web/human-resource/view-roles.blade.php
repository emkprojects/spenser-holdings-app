    ...
    <div class="row">
        <div class="card">
            ...
            <div class="row">
                    ...
                    <div class="col-xl-10">
                        <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All System Roles</h4>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="accordion mt-4" id="accordionWithIcon">
                            ...
                            <div class="accordion-item active">
                                ...
                                <div class="accordion-body" id="role_view"></div>
                                </div>
                            </div>
                ...
                <form method="POST" id="edit-form" nam="edit-form" class="row g-6">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" id="role_reference_edit" name="role_reference" class="form-control" />
                            <input type="hidden" id="role_id_edit" name="role_id" class="form-control" />

                            <div class="col-md-12 form-control-validation">
                                <label class="form-label fs-6" for="role">Role</label>
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text" id="basic-addon-role">
                                        <i class="icon-base ti tabler-file-text"></i>
                                    </span> 
                                    <input type="text" id="role_edit" name="role" class="form-control fs-6" placeholder="Enter Role" style="text-transform:capitalize;" />
                                </div> 
                            </div> 
                            ...
                            <div class="col-md-12 form-control-validation">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea id="description_edit" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Role..." rows="3" style="text-transform:;" ></textarea>
                                </div>
                            </div>            
                ...
                <form method="POST" id="add-form" nam="add-form" class="row g-6">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-control-validation">
                                <label class="form-label fs-6" for="category-type">Role</label>
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text" id="basic-addon-category-type">
                                        <i class="icon-base ti tabler-file-text"></i>
                                    </span> 
                                    <input type="text" id="role" name="role" class="form-control fs-6" placeholder="Enter Role" style="text-transform:capitalize;" />
                                </div> 
                            </div> 
                            ...
                            <div class="col-md-12 form-control-validation">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea id="description" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Role..." rows="3" style="text-transform:capitalize;" ></textarea>
                                </div>
                            </div> 
  ...
  <script>
    $(document).ready(function() {
        ...
        var table =  $('#record-table').DataTable({
            ...
            { data: 'is_active', name: 'roles.is_active'},                           
        ...
        $(document).on('click', '.record-view-btn', function(){
            ...
            $.ajax({
                ...
                success: function(response) {
                  ...
                  $('#role_view').text(response.data.name);
            ...
            var record_id = $(this).attr('id');
              ...
              $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#role_reference_edit').val(response.data.role_reference);
                    $('#role_id_edit').val(response.data.id);
                    $('#role_edit').val(response.data.name);
