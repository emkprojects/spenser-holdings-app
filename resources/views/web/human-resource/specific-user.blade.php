@extends('layouts.admin', ['title' => 'View Employee'])
                        ...
                        <div class="info-container">
                            ...
                            <div class="accordion mt-4" id="accordionWithIcon">
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        @if($user->national_identification_number)
                                            <div class="accordion-body" id="">{{ $user->national_identification_number }}</div>
                                        @else
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">{{ date("l F d, Y", strtotime($user->created_at)) }}</div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body pt-1">
                            ...
                            <div class="accordion mt-4" id="accordionWithIcon">
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                    <div class="accordion-body" id="">{{ $user->name }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">{{ $user->first_name }} {{ $user->last_name }} {{ $user->other_name }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">{{ $user->email }}</div>
                                        @if($user->alternative_email)
                                            <div class="accordion-body" id="">{{ $user->alternative_email }}</div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">+{{ $user->phone }}</div>
                                        @if($user->alternative_phone)
                                            <div class="accordion-body" id="">+{{ $user->alternative_phone }}</div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">{{ $user->position }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                    <div class="accordion-body" id="">{{ ucwords($user->role) }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                    <div class="accordion-body" id="">{{ ucwords($user->user_status) }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">{{ date("l F d, Y", strtotime($user->date_of_birth)) }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">{{ ucwords($user->gender) }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">{{ ucwords($user->physical_address) }}</div>
                                    </div>
                                </div>
