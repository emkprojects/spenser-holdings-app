@extends('layouts.admin', ['title' => 'Add Employee'])
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                        <h4 class="pb-0 mt-1 fs-5 text-md-start text-center fw-bold"> ADD NEW EMPLOYEE</h4>
                        </div>
                    </div>
                    ...
                    <form method="POST" id="add-form" nam="add-form" class="row g-6">
                        ...
                        <div class="col-md-4 form-control-validation">
                           ...
                           <div class="input-group input-group-merge">
                                ...
                                <input type="text" id="other_name" name="other_name" class="form-control" placeholder="Enter Other name (Optional)" style="text-transform:capitalize;" aria-describedby="basic-addon-oname" maxlength="11" />                        
                            </div> 
                        </div> 
                        ...
                        <div class="col-md-4 form-control-validation">
                           ...
                           <div class="input-group input-group-merge">
                                ...
                                <input type="text" id="phone" name="phone" class="form-control phone" placeholder="Enter Mobile Number" style="text-transform:;" aria-describedby="basic-addon-phone" maxlength="11" />                        
                            </div> 
                        </div> 
                        ...
                        <div class="col-md-4 form-control-validation">
                           ...
                           <div class="input-group input-group-merge">
                                ...
                                <input type="email" id="email" name="email" class="form-control" placeholder="Enter Email Address" style="text-transform:;" aria-describedby="basic-addon-email" />                        
                            </div> 
                        </div>
                        ...
                        <div class="col-md-4 form-control-validation">
                           ...
                           <div class="input-group input-group-merge">
                                ...
                                <input type="date" id="date_of_birth" name="date_of_birth" class="form-control" placeholder="Enter Date of Birth (Optional)" style="text-transform:;" aria-describedby="basic-addon-dob" />                        
                            </div> 
                        </div>
