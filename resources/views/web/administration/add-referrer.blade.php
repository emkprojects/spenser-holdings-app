@extends('layouts.admin', ['title' => 'Add referrer'])
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                        <h4 class="pb-0 mt-1 fs-5 text-md-start text-center fw-bold"> ADD NEW REFERRER</h4>
                        </div>
                    </div>
                    ...
                    <form method="POST" id="add-form" nam="add-form" class="row g-6">
                        ...
                        <div class="col-md-4 form-control-validation">
                           ...
                           <div class="input-group input-group-merge">
                                ...
                                <input type="text" id="first_name" name="first_name" class="form-control" placeholder="Enter First Name" style="text-transform:capitalize;" aria-describedby="basic-addon-fname" />                        
                            </div> 
                        </div> 
                        ...
                        <div class="col-md-4 form-control-validation">
                           ...
                           <div class="input-group input-group-merge">
                                ...
                                <input type="text" id="last_name" name="last_name" class="form-control" placeholder="Enter Last Name" style="text-transform:capitalize;" aria-describedby="basic-addon-lname" />                        
                            </div> 
                        </div> 

                        <div class="col-md-4 form-control-validation">
                            <label class="form-label fs-5" for="oname">Other Names</label>
                           <div class="input-group input-group-merge">
                                <span class="input-group-text" id="basic-addon-lname">
                                    <i class="icon-base ti tabler-user"></i>
                                </span>                                    
                                <input type="text" id="other_name" name="other_name" class="form-control" placeholder="Enter Other Names" style="text-transform:capitalize;" aria-describedby="basic-addon-oname" />                        
                            </div> 
                        </div> 
                        ...
                        <div class="col-md-4 form-control-validation">
                            <label class="form-label fs-5" for="alternative_phone">Alternative Mobile</label>
                           <div class="input-group input-group-merge">
                        ...
                        <div class="col-md-4 form-control-validation">
                            <label class="form-label fs-5" for="alternative_email">Email Address</label>
                           <div class="input-group input-group-merge">
                                <span class="input-group-text" id="basic-addon-aemail">
                                    <i class="icon-base ti tabler-mail"></i>
                                </span>                                    
                                <input type="email" id="email_address" name="email_address" class="form-control" placeholder="Enter Email Address" style="text-transform:;" aria-describedby="basic-addon-aemail" />                        
                            </div> 
                        </div>

                        <div class="col-md-4 form-control-validation">
                            <label class="form-label fs-5" for="alternative_email">Alternative Email</label>
                           <div class="input-group input-group-merge">
                                <span class="input-group-text" id="basic-addon-aemail">
                                    <i class="icon-base ti tabler-mail"></i>
                                </span>                                    
                        ...
                        <div class="col-md-4 form-control-validation">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <textarea id="physical_address" name="physical_address" class="form-control autosize fs-5" placeholder="Enter Physical Address... (Optional)" rows="3" style="text-transform:capitalize;" aria-describedby="basic-addon-paddress" ></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12 form-control-validation">
                            <button type="submit" id="add-btn" name="add-btn" class="btn btn-info button-prevent-multiple-submits p-3 float-end">Add Referrer</button>
                        </div>
