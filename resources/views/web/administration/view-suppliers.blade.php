            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-10">
                                <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All Suppliers</h4>
                            </div>

                            @can('add-suppliers')
                            <div class="col-xl-2 float:right;">
                                <a href="/new-supplier" class="btn btn-primary record-view-btn" title="Add Record">
                                    <i class="menu-icon icon-base ti tabler-file-plus"></i> New Supplier
                                </a>
                            </div>
                            @endcan
                    </div>
  ...
  <script>
    $(document).ready(function() {
        ...
        var table =  $('#record-table').DataTable({
            ...
            { data: 'phone_number', name: 'suppliers.phone_number'},
            { data: 'email_address', name: 'suppliers.email_address'}, 
            { data: 'physical_address', name: 'suppliers.physical_address'},
            { data: 'supplier_type', name: 'suppliers.supplier_type'},              
