            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-10">
                                <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All Customers</h4>
                            </div>

                            @can('add-customers')
                            <div class="col-xl-2 float:right;">
                                <a href="/new-customer" class="btn btn-primary record-view-btn" title="Add Record">
                                    <i class="menu-icon icon-base ti tabler-file-plus"></i> New Customer
                                </a>
                            </div>
                            @endcan
                    </div>
