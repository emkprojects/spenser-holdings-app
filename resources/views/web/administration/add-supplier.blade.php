        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                        <h4 class="pb-0 mt-1 fs-5 text-md-start text-center fw-bold"> ADD NEW SUPPLIER</h4>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" id="add-form" nam="add-form" class="row g-6">
                        ...
                        <div class="col-md-4 form-control-validation">
                            <label class="form-label fs-5" for="first_name">Supplier</label>
                           <div class="input-group input-group-merge">
                                <span class="input-group-text" id="basic-addon-fname">
                                    <i class="icon-base ti tabler-user"></i>
                                </span>                                    
                                <input type="text" id="supplier" name="supplier" class="form-control" placeholder="Enter Supplier" style="text-transform:capitalize;" aria-describedby="basic-addon-fname" />                        
                            </div> 
                        </div> 
                        ...
                        <div class="col-12 form-control-validation">
                            <div class="form-check">
                                ...
                                <label class="form-check-label fs-5" for="terms">Supplier has agreed to our terms and conditions</label>
                            </div>
                        </div>

                        <div class="col-12 form-control-validation">
                            <button type="submit" id="add-btn" name="add-btn" class="btn btn-info button-prevent-multiple-submits p-3 float-end">Add Supplier</button>
                        </div>
