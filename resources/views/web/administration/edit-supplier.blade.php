                    ...
                    <form method="POST" id="add-form" nam="add-form" class="row g-6">
                        ...
                        <div class="col-md-4 form-control-validation">
                           ...
                           <div class="input-group input-group-merge">
                                ...
                                <input type="text" value="{{ $supplier->national_identification_number}}" id="national_identification_number" name="national_identification_number" class="form-control" placeholder="Enter NIN (Optional)" style="text-transform:uppercase;" aria-describedby="basic-addon-nin" />                        
                            </div> 
                        </div> 
                        ...
                        <div class="col-md-4 form-control-validation">
                           ...
                           <div class="input-group input-group-merge">
                                ...
                                <input type="text" value="{{ $supplier->tax_identification_number}}" id="tax_identification_number" name="tax_identification_number" class="form-control" placeholder="Enter TIN (Optional)" style="text-transform:uppercase;" aria-describedby="basic-addon-tin" />                        
                            </div> 
                        </div>
