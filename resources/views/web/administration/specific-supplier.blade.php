@extends('layouts.admin', ['title' => 'View Supplier'])
        ...
        <div class="content-wrapper">
          <!-- Content -->
            <div class="flex-grow-1 container-p-y">
                ...
                <div class="row">
                        ...
                        <div class="info-container">
                            ...
                            <div class="accordion mt-4" id="accordionWithIcon">
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        @if($supplier->tax_identification_number)
                                            <div class="accordion-body" id="">{{ $supplier->tax_identification_number }}</div>
                                        @else
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        @if($supplier->national_identification_number)
                                            <div class="accordion-body" id="">{{ $supplier->national_identification_number }}</div>
                                        @else
                                            <div class="accordion-body" id="">...</div>
                                        @endif
                                    </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">{{ date("l F d, Y", strtotime($supplier->created_at)) }}</div>
                                    </div>
                                </div>
                            ...
                            <!-- <ul class="list-unstyled mb-6">
                                <li class="mb-2">
                                    <span class="h6">suppliername:</span>
                    ...
                    <!-- <div class="card mb-6 border border-2 border-primary rounded primary-shadow">
                        ...
                        <ul class="list-unstyled g-2 my-6">
                            <li class="mb-2 d-flex align-items-center"><i class="icon-base ti tabler-circle-filled icon-10px text-secondary me-2"></i><span>10 suppliers</span></li>
                        ...
                        <div class="card-body pt-1">
                            ...
                            <div class="accordion mt-4" id="accordionWithIcon">
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">{{ $supplier->physical_address }}</div>
                                    </div>
                                </div> 
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">{{ $supplier->contact_first_name }} {{ $supplier->contact_last_name }} {{ $supplier->contact_other_name }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">{{ $supplier->contact_email_address }}</div>
                                        @if($supplier->contact_alternative_email)
                                            <div class="accordion-body" id="">{{ $supplier->contact_alternative_email }}</div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">+{{ $supplier->contact_phone_number }}</div>
                                        @if($supplier->contact_alternative_phone)
                                            <div class="accordion-body" id="">+{{ $supplier->contact_alternative_phone }}</div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">{{ $supplier->position }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">{{ ucwords($supplier->contact_gender) }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item active">
                                    ...
                                    <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                                        <div class="accordion-body" id="">{{ ucwords($supplier->contact_physical_address) }}</div>
                                    </div>
                                </div>
                ...
                <div class="modal-dialog modal-lg modal-simple modal-edit-supplier">
                    <div class="modal-content">
                    <div class="modal-body">
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        <div class="text-center mb-6">
                        <h4 class="mb-2">Edit supplier Information</h4>
                        <p>Updating supplier details will receive a privacy audit.</p>
                        </div>
                        <form id="editsupplierForm" class="row g-6" onsubmit="return false">
                        <div class="col-12 col-md-6">
                            <label class="form-label" for="modalEditsupplierFirstName">First Name</label>
                            <input type="text" id="modalEditsupplierFirstName" name="modalEditsupplierFirstName" class="form-control" placeholder="John" value="John" />
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label" for="modalEditsupplierLastName">Last Name</label>
                            <input type="text" id="modalEditsupplierLastName" name="modalEditsupplierLastName" class="form-control" placeholder="Doe" value="Doe" />
                        </div>
                        <div class="col-12">
                            <label class="form-label" for="modalEditsupplierName">suppliername</label>
                            <input type="text" id="modalEditsupplierName" name="modalEditsupplierName" class="form-control" placeholder="johndoe007" value="johndoe007" />
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label" for="modalEditsupplierEmail">Email</label>
                            <input type="text" id="modalEditsupplierEmail" name="modalEditsupplierEmail" class="form-control" placeholder="example@domain.com" value="example@domain.com" />
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label" for="modalEditsupplierStatus">Status</label>
                            <select id="modalEditsupplierStatus" name="modalEditsupplierStatus" class="select2 form-select" aria-label="Default select example">
                        ...
                        <div class="col-12 col-md-6">
                            <label class="form-label" for="modalEditsupplierPhone">Phone Number</label>
                            <div class="input-group">
                            <span class="input-group-text">US (+1)</span>
                            <input type="text" id="modalEditsupplierPhone" name="modalEditsupplierPhone" class="form-control phone-number-mask" placeholder="202 555 0111" value="202 555 0111" />
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label" for="modalEditsupplierLanguage">Language</label>
                            <select id="modalEditsupplierLanguage" name="modalEditsupplierLanguage" class="select2 form-select" multiple>
                        ...
                        <div class="col-12 col-md-6">
                            <label class="form-label" for="modalEditsupplierCountry">Country</label>
                            <select id="modalEditsupplierCountry" name="modalEditsupplierCountry" class="select2 form-select" data-allow-clear="true">
                            <option value="">Select</option>
                ...
                <div class="modal-dialog modal-dialog-centered modal-simple modal-upgrade-plan">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="text-center mb-6">
                        <h2>Upgrade Plan</h2>
                        <p class="text-body-secondary">Choose the best plan for supplier.</p>
                        </div>
                    ...
                    <div class="modal-body">
                        <h6 class="mb-0">supplier current plan is standard plan</h6>
