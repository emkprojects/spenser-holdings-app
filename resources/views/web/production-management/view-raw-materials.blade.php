@extends('layouts.admin', ['title' => 'Raw Materials'])
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-10">
                                <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All Raw Materials</h4>
                            </div>

                            @can('add-raw-materials')
                            <div class="col-xl-2 float:right;">
                                <a href="/new-raw-material" class="btn btn-primary record-view-btn" title="Add Record">
                                    <i class="menu-icon icon-base ti tabler-file-plus"></i> New Raw Material
                                </a>
                            </div>
                            @endcan
                    </div>
  ...
  <script>
    $(document).ready(function() {
        ...
        var table =  $('#record-table').DataTable({
            ...
            { data: 'raw_material', name: 'raw_materials.raw_material'},
            { data: 'inventory_category', name: 'inventory_categories.inventory_category'},            
            { data: 'physical_stock', name: 'raw_materials.physical_stock'},
            { data: 'current_stock', name: 'raw_materials.current_stock'},
            { data: 'minimum_stock', name: 'raw_materials.minimum_stock'},
            { data: 'status', name: 'statuses.status'},             
            { data: 'created_at', name: 'raw_materials.created_at'},             
        ...
        $(document).on('click', '.record-del-btn', function() {
            ...
            Swal.fire({
                ...
                text: "Raw Material will be deleted",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    // },
                    type:'post',
                    url: '/delete-raw-material/'+ record_id,
