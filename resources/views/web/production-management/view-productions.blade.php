@extends('layouts.admin', ['title' => 'Productions'])
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-10">
                                <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All Productions</h4>
                            </div>

                            @can('add-productions')
                            <div class="col-xl-2 float:right;">
                                <a href="/new-production" class="btn btn-primary record-view-btn" title="Add Record">
                                    <i class="menu-icon icon-base ti tabler-file-plus"></i> New Production
                                </a>
                            </div>
                            @endcan
                    </div>
  ...
  <script>
    $(document).ready(function() {
        ...
        var table =  $('#record-table').DataTable({
            ...
            { data: 'production_reference_no', name: 'productions.production_reference_no'},
            { data: 'production', name: 'productions.production'},
            { data: 'date_of_production', name: 'productions.date_of_production'},
            { data: 'status', name: 'statuses.status'},
            { data: 'supervisor', name: 'productions.supervisor'},            
        ...
        $(document).on('click', '.record-del-btn', function() {
            ...
            Swal.fire({
                ...
                text: "Production will be deleted",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    // },
                    type:'post',
                    url: '/delete-production/'+ record_id,
