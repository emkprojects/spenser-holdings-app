            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-10">
                                <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All Inventory</h4>
                            </div>

                            @can('add-inventories')
                            <div class="col-xl-2 float:right;">
                                <a href="/new-inventory" class="btn btn-primary record-view-btn" title="Add Record">
                                    <i class="menu-icon icon-base ti tabler-file-plus"></i> New Inventory
                                </a>
                            </div>
                            @endcan
                    </div>
  ...
  <script>
    $(document).ready(function() {
        ...
        var table =  $('#record-table').DataTable({
            ...
            { data: 'item', name: 'items.item'},
            { data: 'physical_stock', name: 'inventories.physical_stock'},
            { data: 'current_stock', name: 'inventories.current_stock'},
            { data: 'date_of_inventory', name: 'inventories.date_of_inventory'},
            { data: 'status', name: 'statuses.status'}, 
            { data: 'purchase', name: 'purchases.purchase'},             
        ...
        $(document).on('click', '.record-del-btn', function() {
            ...
            Swal.fire({
                ...
                text: "Inventory will be deleted",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    // },
                    type:'post',
                    url: '/delete-inventory/'+ record_id,
