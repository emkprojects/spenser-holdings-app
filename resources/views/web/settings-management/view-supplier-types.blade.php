@extends('layouts.admin', ['title' => 'Supplier Types'])
    ...
    <div class="row">
        <div class="card">
            ...
            <div class="row">
                    ...
                    <div class="col-xl-10">
                        <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All Supplier Types</h4>
                    </div>

                    @can('add-supplier-types')
                    ...
                    <div class="row">
                        ...
                        <div class="accordion mt-4" id="accordionWithIcon">
                            ...
                            <div class="accordion-item active">
                                ...
                                <div class="accordion-body" id="supplier_type_view"></div>
                                </div>
                            </div>
                ...
                <form method="POST" id="edit-form" nam="edit-form" class="row g-6">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" id="supplier_type_reference_edit" name="supplier_type_reference" class="form-control" />

                            <div class="col-md-12 form-control-validation">
                                <label class="form-label fs-6" for="supplier-type">Supplier Type</label>
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text" id="basic-addon-supplier-type">
                                        <i class="icon-base ti tabler-file-text"></i>
                                    </span> 
                                    <input type="text" id="supplier_type_edit" name="supplier_type" class="form-control fs-6" placeholder="Enter Supplier Type" style="text-transform:capitalize;" />
                                </div> 
                            </div> 
                            ...
                            <div class="col-md-12 form-control-validation">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea id="description_edit" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Supplier Type..." rows="3" style="text-transform:;" ></textarea>
                                </div>
                            </div>            
                ...
                <form method="POST" id="add-form" nam="add-form" class="row g-6">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-control-validation">
                                <label class="form-label fs-6" for="category-type">Supplier Type</label>
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text" id="basic-addon-category-type">
                                        <i class="icon-base ti tabler-file-text"></i>
                                    </span> 
                                    <input type="text" id="supplier_type" name="supplier_type" class="form-control fs-6" placeholder="Enter Supplier Type" style="text-transform:capitalize;" />
                                </div> 
                            </div> 
                            ...
                            <div class="col-md-12 form-control-validation">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea id="description" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Supplier Type..." rows="3" style="text-transform:capitalize;" ></textarea>
                                </div>
                            </div> 
  ...
  <script>
    $(document).ready(function() {
        ...
        var table =  $('#record-table').DataTable({
            ...
            { data: 'supplier_type', name: 'supplier_types.supplier_type'},
            { data: 'description', name: 'supplier_types.description'},
            { data: 'is_active', name: 'supplier_types.is_active'},                           
            { data: 'created_at', name: 'supplier_types.created_at' },
            ...
            "columnDefs": [
            {
                "targets": 2, // Target the column index you want to truncate (0-indexed)
                "data": "description", // Replace with the actual data property name for that column
        ...
        $(document).on('click', '.record-view-btn', function(){
            ...
            $.ajax({
                url: '/specific-supplier-type/'+ record_id,
                type: 'GET',
                ...
                success: function(response) {
                  ...
                  $('#record_header_view').text(response.data.supplier_type);

                  $('#supplier_type_view').text(response.data.supplier_type);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            //window.location = "/supplier-types";
                            table.ajax.reload();
        ...
        $(document).on('click', '.record-edit-btn', function(){
            var record_id = $(this).attr('id');
              ...
              $.ajax({
                url: '/edit-supplier-type/'+ record_id,
                type: 'GET',
                ...
                success: function(response) {
                    ...
                    $('#record_header_edit').text(response.data.supplier_type);

                    $('#supplier_type_reference_edit').val(response.data.supplier_type_reference);
                    $('#supplier_type_edit').val(response.data.supplier_type);
        ...
        $(document).on('click', '.record-del-btn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    // },
                    type:'post',
                    url: '/delete-supplier-type/'+ record_id,
