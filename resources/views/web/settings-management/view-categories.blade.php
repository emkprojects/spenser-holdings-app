...
@section('content')
    ...
    <div class="row">
      <div class="card">
        ...
        <div class="card-header">
          ...
          <div class="row">
            <div class="col-xl-10">
              <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All Categories</h4>
            </div>
    ...
    <div class="modal modal-lg fade animate__fadeInDownBig" id="viewRecordModal" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog">
        ...
        <div class="modal-header">
          <h5 class="modal-title fw-bold fs-5" id="viewRecordModalTitle">RECORD FOR <span class="text text-primary" id="record_header_view" style="text-transform:uppercase;"></span> CATEGORY</h5>
    ...
    <div class="modal modal-lg fade animate__fadeInDownBig" id="editRecordModal" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog">
        ...
        <div class="modal-header">
          <h5 class="modal-title fw-bold fs-5" id="editRecordModalTitle">UPDATE <span class="text text-primary" id="record_header_edit" style="text-transform:uppercase;"></span> CATEGORY RECORD</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <input type="hidden" id="category_reference_edit" name="category_reference" class="form-control" />

            <div class="col-md-12 form-control-validation">
                <label class="form-label fs-6" for="category-type">Category</label>
                <div class="input-group input-group-merge">
                    <span class="input-group-text" id="basic-addon-category-type">
                        <i class="icon-base ti tabler-file-text"></i>
                    </span> 
                    <input type="text" id="category_edit" name="category_type" class="form-control fs-6" placeholder="Enter Category Type" style="text-transform:capitalize;" />
                </div> 
            </div> 
            ...
            <div class="col-md-12 form-control-validation">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <textarea id="description_edit" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Category..." rows="3" style="text-transform:capitalize;" ></textarea>
                </div>
            </div>          
    ...
    <div class="modal modal-lg fade animate__fadeInDownBig" id="addRecordModal" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog">
        ...
        <div class="modal-header">
          <h5 class="modal-title fw-bold fs-5" id="addRecordModalTitle">ADD <span class="text text-primary" id="record_header" style="text-transform:uppercase;">NEW</span> CATEGORY RECORD</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12 form-control-validation">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <input type="text" id="category" name="category" class="form-control fs-6" placeholder="Enter Category Type" style="text-transform:capitalize;" />
                </div> 
            </div> 
            ...
            <div class="col-md-12 form-control-validation">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <textarea id="description" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Category..." rows="3" style="text-transform:capitalize;" ></textarea>
                </div>
            </div>          
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.record-edit-btn', function(){
            var record_id = $(this).attr('id');
              ...
              $.ajax({
                url: '/specific-category/'+ record_id,
                type: 'GET',
