@extends('layouts.admin', ['title' => 'Inventory Categories'])
    ...
    <div class="row">
        <div class="card">
            ...
            <div class="row">
                    ...
                    <div class="col-xl-10">
                        <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All Inventory Categories</h4>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="accordion mt-4" id="accordionWithIcon">
                            ...
                            <div class="accordion-item active">
                                ...
                                <div class="accordion-body" id="inventory_category_view"></div>
                                </div>
                            </div>
                ...
                <form method="POST" id="edit-form" nam="edit-form" class="row g-6">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" id="inventory_category_reference_edit" name="inventory_category_reference" class="form-control" />

                            <div class="col-md-12 form-control-validation">
                                <label class="form-label fs-6" for="inventory-category">Inventory Category</label>
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text" id="basic-addon-inventory-category">
                                        <i class="icon-base ti tabler-file-text"></i>
                                    </span> 
                                    <input type="text" id="inventory_category_edit" name="inventory_category" class="form-control fs-6" placeholder="Enter Inventory Category" style="text-transform:capitalize;" />
                                </div> 
                            </div> 
                            ...
                            <div class="col-md-12 form-control-validation">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea id="description_edit" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Inventory Category..." rows="3" style="text-transform:;" ></textarea>
                                </div>
                            </div>            
                ...
                <form method="POST" id="add-form" nam="add-form" class="row g-6">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-control-validation">
                                <label class="form-label fs-6" for="category-type">Inventory Category</label>
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text" id="basic-addon-category-type">
                                        <i class="icon-base ti tabler-file-text"></i>
                                    </span> 
                                    <input type="text" id="inventory_category" name="inventory_category" class="form-control fs-6" placeholder="Enter Inventory Category" style="text-transform:capitalize;" />
                                </div> 
                            </div> 
                            ...
                            <div class="col-md-12 form-control-validation">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea id="description" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Inventory Category..." rows="3" style="text-transform:capitalize;" ></textarea>
                                </div>
                            </div> 
  ...
  <script>
    $(document).ready(function() {
        ...
        var table =  $('#record-table').DataTable({
            ...
            { data: 'inventory_category', name: 'inventory_categories.inventory_category'},
            { data: 'description', name: 'inventory_categories.description'},
            { data: 'is_active', name: 'inventory_categories.is_active'},                           
            { data: 'created_at', name: 'inventory_categories.created_at' },
        ...
        $(document).on('click', '.record-view-btn', function(){
            ...
            $.ajax({
                url: '/specific-inventory-category/'+ record_id,
                type: 'GET',
                ...
                success: function(response) {
                  ...
                  $('#record_header_view').text(response.data.inventory_category);

                  $('#inventory_category_view').text(response.data.inventory_category);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            //window.location = "/inventory-categorys";
                            table.ajax.reload();
        ...
        $(document).on('click', '.record-edit-btn', function(){
            var record_id = $(this).attr('id');
              ...
              $.ajax({
                url: '/edit-inventory-category/'+ record_id,
                type: 'GET',
                ...
                success: function(response) {
                    ...
                    $('#record_header_edit').text(response.data.inventory_category);

                    $('#inventory_category_reference_edit').val(response.data.inventory_category_reference);
                    $('#inventory_category_edit').val(response.data.inventory_category);
        ...
        $(document).on('click', '.record-del-btn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    // },
                    type:'post',
                    url: '/delete-inventory-category/'+ record_id,
