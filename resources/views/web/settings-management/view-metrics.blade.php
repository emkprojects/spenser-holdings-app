@extends('layouts.admin', ['title' => 'Metrics'])
...
@section('content')
    ...
    <div class="row">
      <div class="card">
        ...
        <div class="card-header">
          ...
          <div class="row">
            <div class="col-xl-10">
              <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All Metrics</h4>
            </div>
    ...
    <div class="modal modal-lg fade animate__fadeInDownBig" id="viewRecordModal" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog">
        ...
        <div class="modal-header">
          <h5 class="modal-title fw-bold fs-5" id="viewRecordModalTitle">RECORD FOR <span class="text text-primary" id="record_header_view" style="text-transform:uppercase;"></span> UNIT MEASURE</h5>
            ...
            <div class="accordion mt-4" id="accordionWithIcon">
              ...
              <div class="accordion-item active">
                ...
                <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                  <div class="accordion-body" id="metri_view"></div>
                </div>
              </div>
    ...
    <div class="modal modal-lg fade animate__fadeInDownBig" id="editRecordModal" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog">
        ...
        <div class="modal-header">
          <h5 class="modal-title fw-bold fs-5" id="editRecordModalTitle">UPDATE <span class="text text-primary" id="record_header_edit" style="text-transform:uppercase;"></span> UNIT MEASURE RECORD</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <input type="hidden" id="unit_measure_reference_edit" name="unit_measure_reference" class="form-control" />

            <div class="col-md-12 form-control-validation">
                <label class="form-label fs-6" for="category-type">Unit Measure</label>
                <div class="input-group input-group-merge">
                    <span class="input-group-text" id="basic-addon-category-type">
                        <i class="icon-base ti tabler-file-text"></i>
                    </span> 
                    <input type="text" id="unit_measure_edit" name="unit_measure" class="form-control fs-6" placeholder="Enter Unit Measure" style="text-transform:capitalize;" />
                </div> 
            </div> 
            ...
            <div class="col-md-12 form-control-validation">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <textarea id="description_edit" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Unit Measure..." rows="3" style="text-transform:capitalize;" ></textarea>
                </div>
            </div>          
    ...
    <div class="modal modal-lg fade animate__fadeInDownBig" id="addRecordModal" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog">
        ...
        <div class="modal-header">
          <h5 class="modal-title fw-bold fs-5" id="addRecordModalTitle">ADD <span class="text text-primary" id="record_header" style="text-transform:uppercase;">NEW</span> UNIT MEASURE RECORD</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12 form-control-validation">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <input type="text" id="unit_measure" name="unit_measure" class="form-control fs-6" placeholder="Enter Unit Measure" style="text-transform:capitalize;" />
                </div> 
            </div> 
            ...
            <div class="col-md-12 form-control-validation">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <textarea id="description" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Unit Measure..." rows="3" style="text-transform:capitalize;" ></textarea>
                </div>
            </div>          
    ...
    $(document).ready(function() {
          ...
          var table =  $('#record-table').DataTable({
                          ...
                          columns: [
                            ...
                            { data: 'metric', name: 'metrics.metric'},
                            { data: 'metric_code', name: 'metrics.metric_code'},
                            { data: 'description', name: 'metrics.description'},
                            { data: 'created_at', name: 'metrics.created_at' },
            ...
            var record_id = $(this).attr('id');
              ...
              $.ajax({
                ...
                success: function(response) {
                  ...
                  $('#record_header_edit').text(response.data.metric);
                
                  $('#metric_reference_edit').val(response.data.metric_reference);
                  $('#metric_edit').val(response.data.metric);
        ...
        $(document).on('click', '.record-view-btn', function(){
            ...
            $.ajax({
                ...
                success: function(response) {
                  ...
                  $('#record_header_view').text(response.data.metric);

                  $('#metric_view').text(response.data.metric);
