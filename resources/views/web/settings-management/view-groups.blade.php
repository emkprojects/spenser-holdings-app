...
@section('content')
    ...
    <div class="row">
      <div class="card">
        ...
        <div class="card-header">
          ...
          <div class="row">
            <div class="col-xl-10">
              <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All System Groups</h4>
            </div>
    ...
    <div class="modal modal-lg fade animate__fadeInDownBig" id="viewRecordModal" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog">
        ...
        <div class="modal-header">
          <h5 class="modal-title fw-bold fs-5" id="viewRecordModalTitle">RECORD FOR <span class="text text-primary" id="record_header_view" style="text-transform:uppercase;"></span> GROUP</h5>
    ...
    <div class="modal modal-lg fade animate__fadeInDownBig" id="editRecordModal" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog">
        ...
        <div class="modal-header">
          <h5 class="modal-title fw-bold fs-5" id="editRecordModalTitle">UPDATE <span class="text text-primary" id="record_header_edit" style="text-transform:uppercase;"></span> GROUP RECORD</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <input type="hidden" id="group_reference_edit" name="group_reference" class="form-control" />

            <div class="col-md-12 form-control-validation">
                <label class="form-label fs-6" for="group">Group</label>
                <div class="input-group input-group-merge">
                    <span class="input-group-text" id="basic-addon-group">
                        <i class="icon-base ti tabler-file-text"></i>
                    </span> 
                    <input type="text" id="group_edit" name="group" class="form-control fs-6" placeholder="Enter Group" style="text-transform:capitalize;" />
                </div> 
            </div> 
            ...
            <div class="col-md-12 form-control-validation">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <textarea id="description_edit" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Group..." rows="3" style="text-transform:capitalize;" ></textarea>
                </div>
            </div>          
    ...
    <div class="modal modal-lg fade animate__fadeInDownBig" id="addRecordModal" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog">
        ...
        <div class="modal-header">
          <h5 class="modal-title fw-bold fs-5" id="addRecordModalTitle">ADD <span class="text text-primary" id="record_header" style="text-transform:uppercase;">NEW</span> GROUP RECORD</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12 form-control-validation">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <input type="text" id="group" name="group" class="form-control fs-6" placeholder="Enter Group" style="text-transform:capitalize;" />
                </div> 
            </div> 
            ...
            <div class="col-md-12 form-control-validation">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <textarea id="description" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Group..." rows="3" style="text-transform:capitalize;" ></textarea>
                </div>
            </div>          
    ...
    $(document).ready(function() {
          ...
          var table =  $('#record-table').DataTable({
                          ...
                          columns: [
                            ...
                            { data: 'created_at', name: 'groups.created_at' },
            ...
            var record_id = $(this).attr('id');
              ...
              $.ajax({
                ...
                success: function(response) {
                  ...
                  $('#record_header_edit').text(response.data.group);
                
                  $('#group_reference_edit').val(response.data.group_reference);
                  $('#group_edit').val(response.data.group);
        ...
        $(document).on('click', '.record-view-btn', function(){
            ...
            $.ajax({
                ...
                success: function(response) {
                  ...
                  $('#record_header_view').text(response.data.group);
