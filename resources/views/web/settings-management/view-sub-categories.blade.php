@extends('layouts.admin', ['title' => 'Sub Categories'])
...
@section('content')
    ...
    <div class="row">
      <div class="card">
        ...
        <div class="card-header">
          ...
          <div class="row">
            <div class="col-xl-10">
              <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All Sub Categories</h4>
            </div>
    ...
    <div class="modal modal-lg fade animate__fadeInDownBig" id="viewRecordModal" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog">
        ...
        <div class="modal-header">
          <h5 class="modal-title fw-bold fs-5" id="viewRecordModalTitle">RECORD FOR <span class="text text-primary" id="record_header_view" style="text-transform:uppercase;"></span> CATEGORY TYPE</h5>
            ...
            <div class="accordion mt-4" id="accordionWithIcon">
              ...
              <div class="accordion-item active">
                ...
                <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                  <div class="accordion-body" id="sub_category_view"></div>
                </div>
              </div>
    ...
    <div class="modal modal-lg fade animate__fadeInDownBig" id="editRecordModal" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog">
        ...
        <div class="modal-header">
          <h5 class="modal-title fw-bold fs-5" id="editRecordModalTitle">UPDATE <span class="text text-primary" id="record_header_edit" style="text-transform:uppercase;"></span> CATEGORY TYPE RECORD</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <input type="hidden" id="sub_category_reference_edit" name="sub_category_reference" class="form-control" />

            <div class="col-md-12 form-control-validation">
                <label class="form-label fs-6" for="sub-category">Sub Category</label>
                <div class="input-group input-group-merge">
                    <span class="input-group-text" id="basic-addon-sub-category">
                        <i class="icon-base ti tabler-file-text"></i>
                    </span> 
                    <input type="text" id="sub_category_edit" name="sub_category" class="form-control fs-6" placeholder="Enter Sub Category" style="text-transform:capitalize;" />
                </div> 
            </div> 
            ...
            <div class="col-md-12 form-control-validation">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <textarea id="description_edit" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Sub Category..." rows="3" style="text-transform:capitalize;" ></textarea>
                </div>
            </div>   
            ...
            <!-- <div class="col-md-12 form-control-validation">
                <label class="form-label fs-6" for="category_id_edit">Parent Category</label>
                <div class="input-group input-group-merge">                    
                    
                    <select id="category_id_edit" name="category_id" class="select2 form-select fs-6" style="text-transform:capitalize;">
                        <option value="">Select Parent Category</option>
                        @foreach($categories as $category)
                            <option value="{{$category->category_reference}}">{{$category->category}}</option>
                        @endforeach
            ...
            <div class="col-md-12 form-control-validation">
                <label class="form-label fs-6" for="is_active_edit">Category Status</label>
                <div class="input-group input-group-merge">                    
    ...
    <div class="modal modal-lg fade animate__fadeInDownBig" id="addRecordModal" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog">
        ...
        <div class="modal-header">
          <h5 class="modal-title fw-bold fs-5" id="addRecordModalTitle">ADD <span class="text text-primary" id="record_header" style="text-transform:uppercase;">NEW</span> SUB CATEGORY RECORD</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-12 form-control-validation">
                <label class="form-label fs-6" for="category-type">Sub Category</label>
                <div class="input-group input-group-merge">
                    <span class="input-group-text" id="basic-addon-category-type">
                        <i class="icon-base ti tabler-file-text"></i>
                    </span> 
                    <input type="text" id="sub_category" name="sub_category" class="form-control fs-6" placeholder="Enter Sub Category" style="text-transform:capitalize;" />
                </div> 
            </div> 
            ...
            <div class="col-md-12 form-control-validation">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <textarea id="description" name="description" class="form-control autosize fs-6" placeholder="Describe something about the Sub Category..." rows="3" style="text-transform:capitalize;" ></textarea>
                </div>
            </div>          
  ...
  <script>
    $(document).ready(function() {
          ...
          var table =  $('#record-table').DataTable({
                          processing: true,
                          serverSide: true,
                          ajax: "/view-sub-categories",
                          columns: [
                            { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable:false, searchable:false},
                            { data: 'sub_category', name: 'sub_categories.sub_category'},
                            { data: 'description', name: 'sub_categories.description'},
                            // { data: 'category', name: 'categories.category'},
                            // { data: 'category_type', name: 'category_types.category_type'},                            
                            { data: 'created_at', name: 'sub_category.created_at' },
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            window.location = "/view-sub-categories";
        ...
        $(document).on('click', '.record-edit-btn', function(){
            var record_id = $(this).attr('id');
              ...
              $.ajax({
                url: '/specific-sub-category/'+ record_id,
                type: 'GET',
                ...
                success: function(response) {
                    ...
                    $('#record_header_edit').text(response.data.sub_category);

                    $('#sub_category_reference_edit').val(response.data.sub_category_reference);
                    $('#sub_category_edit').val(response.data.sub_category);
                    $('#description_edit').html(response.data.description);

                    //$('#is_active_edit').text(response.data.is_active);
        ...
        $(document).on('click', '.record-view-btn', function(){
            ...
            $.ajax({
                ...
                success: function(response) {
                  ...
                  $('#record_header_view').text(response.data.sub_category);

                  $('#sub_category_view').text(response.data.sub_category);
                  $('#description_view').text(response.data.description);
                //   $('#category_view').text(response.data.category);
                //   $('#category_type_view').text(response.data.category_type);
              ...
              Swal.fire({
                  ...
                  if (result.isConfirmed) {
                      ...
                      $.ajax({
                        ...
                        // },
                        type:'post',
                        url: '/delete-sub-category/'+ record_id,
