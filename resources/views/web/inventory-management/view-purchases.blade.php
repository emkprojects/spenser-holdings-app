            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-10">
                                <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All Purchases</h4>
                            </div>

                            @can('add-purchases')
                            <div class="col-xl-2 float:right;">
                                <a href="/new-purhase" class="btn btn-primary record-view-btn" title="Add Record">
                                    <i class="menu-icon icon-base ti tabler-file-plus"></i> New Purchase
                                </a>
                            </div>
                            @endcan
                    </div>
  ...
  <script>
    $(document).ready(function() {
        ...
        var table =  $('#record-table').DataTable({
            ...
            // { data: 'manufacture_date', name: 'purchases.manufacture_date'},
            { data: 'expiry_date', name: 'purchases.expiry_date'},
            { data: 'quantity', name: 'purchases.quantity'},
            { data: 'unit_cost', name: 'purchases.unit_cost'},
            { data: 'total_amount', name: 'total_amount', searchable:false}, 
            { data: 'date_of_purchase', name: 'purchases.date_of_purchase'},
