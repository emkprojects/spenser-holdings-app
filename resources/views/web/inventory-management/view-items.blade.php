@extends('layouts.admin', ['title' => 'Items'])
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-10">
                                <h4 class="pb-0 mt-1 text-md-start text-center fw-bold">All Items</h4>
                            </div>

                            @can('add-items')
                            <div class="col-xl-2 float:right;">
                                <a href="/new-item" class="btn btn-primary record-view-btn" title="Add Record">
                                    <i class="menu-icon icon-base ti tabler-file-plus"></i> New Item
                                </a>
                            </div>
                            @endcan
                    </div>
  ...
  <script>
    $(document).ready(function() {
        ...
        var table =  $('#record-table').DataTable({
            ...
            { data: 'current_stock', name: 'items.current_stock'}, 
            { data: 'amount', name: 'items.amount'},
            { data: 'total_amount', name: 'total_amount', searchable:false}, 
            { data: 'minimum_stock', name: 'items.minimum_stock'}, 
